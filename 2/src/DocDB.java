...
public class DocDB { 
 ...
 //OK porque o _store é final, logo no fim do construtor o Java garante com o final que este objecto está construido
 public DocDB(int sz) { 
 ...
 public void update(int id, String newText) {
		 ...
		 _store[id].ref = new Doc(_store[id].ref.version.incrementAndGet(), newText); // com o volatile no ref garanto que esta escrita é actualizada.
