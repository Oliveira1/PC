...
namespace MyServer
{
    ...
    public sealed class Handler
    {
        ...
        /// </summary>
        private static async void ProcessRegisterMessage(StreamReader input, StreamWriter output, Logger log)
        {
            // Read message payload, terminated by an empty line. 
            // Each payload line has the following format
            // <filename>:<ipAddress>:<portNumber>
           
            //TODO SE FUNCIONAR ESTE METODO APLICAR EM TODOS.
            String line =  await input.ReadToEndAsync();
    ...
    public sealed class Listener
    {
        ...
        {
            var client=srv.EndAcceptTcpClient(ar);

            //TODO  PASSAR PARA O LOGGER
        ...
        {
            Handler protocolHandler = new Handler(client.GetStream(), _log);
         protocolHandler.Run();
        }
    }
